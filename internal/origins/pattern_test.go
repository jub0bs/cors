...
func TestIsDeemedInsecure(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			pattern: "https://foo.localhost",
			want:    false,
		}, {
			pattern: "http://foo.localhost",
			want:    false,
		}, {
			pattern: "https://foo.bar.baz.localhost",
			want:    false,
		}, {
			pattern: "http://foo.bar.baz.localhost",
			want:    false,
		}, {
			pattern: "http://alocalhost",
			want:    true,
		}, {
			pattern: "http://*.alocalhost",
			want:    true,
		}, {
			pattern: "http://foo.alocalhost",
			want:    true,
		}, {
			pattern: "http://foo.bar.baz.alocalhost",
			want:    true,
		}, {
			pattern: "http://localhosta",
			want:    true,
		}, {
			pattern: "http://*.localhosta",
			want:    true,
		}, {
			pattern: "http://foo.localhosta",
			want:    true,
		}, {
			pattern: "http://foo.bar.baz.localhosta",
			want:    true,
		}, {
			pattern: "https://localhost.",
			want:    false,
