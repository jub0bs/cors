...
- **Performance**: Middleware initialization and reconfiguration now incurs
  fewer heap allocations.
- **Dependencies**: update to golang.org/x/net v0.59.0
...
- **Dependencies**: update to golang.org/x/net v0.56.0

## [1.0.3] (2026-05-22)

### Changed

- **Tests**: `util.SortedSet`'s test suite has been augmented with a fuzz test.
- **Dependencies**: update to golang.org/x/net v0.55.0
...
- **Documentation**: The README now correctly lists the two major Go versions
  supported by this library.
- **Dependencies**: update to golang.org/x/net v0.53.0
...
- **Performance**: minor improvements
- **Documentation**: Contribution guidelines have been clarified.
- **Documentation**: The security policy now relies on GitHub's
...
- **Performance**: Middleware execution is now a bit faster.
...
- **Tests**: minor improvements
- **Dependencies**: update to golang.org/x/net v0.52.0

## [0.13.2] (2026-02-27)

### Fixed

- **Bug**: inconsequential off-by-one error in `internal/headers` package

### Changed

- **Tests**: More parsing edge cases are now covered.
...
- **Performance**: Middleware initialization and reconfiguration now require
  less heap allocation in failure cases.
- **Dependencies**: update to golang.org/x/net v0.46.0
...
- **API**: add a `Debug` method on `*Middleware` for querying the middleware's
  debug mode

### Changed

- **Behavior**: Reconfiguring a middleware now leaves its debug mode unchanged.
- **Performance**: minor improvements
- **Tests**: minor improvements
- **Documentation**: minor improvements
...
- **Dependencies**: Go 1.24 (or above) is now required.
- **Dependencies**: update to golang.org/x/net v0.43.0
...
[0.13.2]: https://github.com/jub0bs/cors/compare/v0.13.1...v0.13.2
